...
import Fundaciones from "../../datos/fundaciones"
    ...
    return (
      <div>
        ...
        <form className={styles.contenedorPrincipal} onSubmit={this.submit}>
          <Searcher contBuscador="¿En que fundacion queres retirar?" title="FUNDACIONES AMIGAS" buscador={this.buscador}/>
          <ContainerFundaciones datosFundaciones={Fundaciones} cambio={this.cambio}  contBuscador={this.state.buscador}/>
